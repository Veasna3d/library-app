...
foreach ($result as $row) {
    ...
    '&nbsp;&nbsp;&nbsp;<button type="button" name="delete" id="' . $row["id"] . '" class="btn btn-danger btn-xs delete mx-4"><i class="fa fa-trash-o" aria-hidden="true"></i></button>'.
     '&nbsp;&nbsp;&nbsp;<button type="button" name="test" id="' . $row["id"] .'" class="btn btn-info btn-xs test mx-4"><i class="fa fa-refresh" aria-hidden="true"></i></button>';
    $data[] = $sub_array;
}
$output = array(
